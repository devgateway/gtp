...
var _PivotTable = require('react-pivottable/PivotTable')
  ...
  _createClass(DraggableAttribute, [{
    ...
    value: function render () {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('span', { className: 'pvtAttr ' + filtered }, this.props.name,
          _react2.default.createElement('span', { className: 'pvtTriangle', onClick: this.toggleFilterBox.bind(this) },
            ' ',
            '\u25BE'
...
var PivotTableUI = (function (_React$PureComponent2) {
  ...
  _createClass(PivotTableUI, [{
    ...
    value: function makeDnDCell (items, onChange, classes) {
      ...
      var tooltip
      if (classes.indexOf('pvtUnused') > 1) {
        tooltip = _react2.default.createElement('div', { className: 'pvtHelpTip' }, _react2.default.createElement(_intl.injectIntl(({ intl }) => intl.formatMessage(_messages.default.table_help_unused_cols))))
      }
      if (classes.indexOf('pvtCols') > 1) {
        tooltip = _react2.default.createElement('div', { className: 'pvtHelpTip' }, _react2.default.createElement(_intl.injectIntl(({ intl }) => intl.formatMessage(_messages.default.table_help_used_cols))))
      }

      if (classes.indexOf('pvtRows') > 1) {
        tooltip = _react2.default.createElement('div', { className: 'pvtHelpTip' }, _react2.default.createElement(_intl.injectIntl(({ intl }) => intl.formatMessage(_messages.default.table_help_used_rows))))
      }

      return _react2.default.createElement('td', { className: classes }, tooltip, _react2.default.createElement(_reactSortablejs2.default,
        {
          options: {
            group: 'shared',
