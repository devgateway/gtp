  ...
  return (<div className="core-filters">
    <div className="main filter nav">
      <div className="filter nav item title">
        <FormattedMessage id="indicators.main.filter.title" defaultMessage="Indicator Filter"></FormattedMessage>
      </div>
      ...
      <div className="filter nav item">
        ...
        text={<FormattedMessage id = "indicators.main.filter.year" defaultMessage = "Campain/Years" > </FormattedMessage>}
      ...
      <div className="filter nav item">
        <CustomFilterDropDown onChange={s=>onChange('region',s)} selected={globalFilters&&globalFilters.get('region')?globalFilters.get('region').toJS():[]}
         text={<FormattedMessage id = "indicators.main.filter.regions" defaultMessage = "Regions" > </FormattedMessage>}
