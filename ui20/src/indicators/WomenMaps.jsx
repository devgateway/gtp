    ...
    const byAgePanes=[
      {
        ...
        render: () =>
           <div className="indicators chart women">
             ...
             <div className="chart container png exportable"><BarChart bottomLegend={props.intl.formatMessage(messages.age)}  {...getWomenDistributionByGroup(props.population,props.intl)}></BarChart></div>
           </div>,
      },
      {
        ...
        render: () =><div className="indicators chart women">
              ...
              <div className="chart container png exportable"><LineChart   {...getWomebHistoricalDistribution(props.population,props.intl)}/></div>
            </div>,
      ...
      const byMethodPanes=[
        {
          ...
          render: () =><div className="indicators chart women">
                ...
                <div className="chart container png exportable"><BarChart bottomLegend={props.intl.formatMessage(messages.methodOfEnforcement)}  {...getWomenDistributionByGroup(props.distribution,props.intl)}></BarChart></div>
              </div>,
        ...
        },
        {
          ...
          render: () =><div className="indicators chart women">
                ...
                <div className="chart container png exportable"><LineChart  key="ByMethodOfEnforcementLine"  {...getWomebHistoricalDistribution(props.distribution,props.intl)}></LineChart></div>
              </div>,
