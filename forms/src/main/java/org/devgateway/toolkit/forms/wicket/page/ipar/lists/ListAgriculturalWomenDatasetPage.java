...
import org.devgateway.toolkit.forms.wicket.page.ipar.edit.EditAgriculturalWomenDatasetPage;
...
public class ListAgriculturalWomenDatasetPage extends AbstractListPage<AgriculturalWomenDataset> {
    ...
    public ListAgriculturalWomenDatasetPage(final PageParameters pageParameters) {
        ...
        columns.add(new PropertyColumn<>(
                new StringResourceModel("name", ListAgriculturalWomenDatasetPage.this),
                "label", "label"));
        columns.add(new PropertyColumn<>(
                new StringResourceModel("organization", ListAgriculturalWomenDatasetPage.this),
