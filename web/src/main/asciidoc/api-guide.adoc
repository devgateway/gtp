...
=== Get all GTP bulletins

Returns all available GTP bulletins.
...
include::{snippets}/gtp-bulletins/response-fields-annualReports.adoc[]

[[gtp-bulletin]]
GTP bulletin fields:

include::{snippets}/gtp-bulletins/response-fields-bulletins.adoc[]
