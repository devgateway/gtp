...
operation::rain-map-config[snippets='curl-request,http-response,response-fields']
...
operation::rain-map-layer-returned[snippets='curl-request,http-request,request-fields']
